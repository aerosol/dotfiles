...
hi ColorColumn guibg=#F0F6FF ctermbg=15
hi LineNr  guifg=#808080 ctermfg=134 guibg=#EFEFEF ctermbg=NONE
hi VertSplit  guifg=#FFFFFF ctermfg=15 guibg=#CFCFCF ctermbg=252 gui=NONE
hi MatchParen  guifg=#FFFFFF ctermfg=27 guibg=#E18AC7 gui=bold
...
hi Comment  guifg=#555555 ctermfg=27 gui=italic
...
" Diff styles {{{1
hi DiffAdd guifg=white guibg=#007B22 ctermfg=28 ctermbg=15
hi DiffChange guifg=white guibg=#D51015 ctermfg=28 ctermbg=15
hi DiffText guifg=white guibg=#0066FF ctermfg=28 ctermbg=15
