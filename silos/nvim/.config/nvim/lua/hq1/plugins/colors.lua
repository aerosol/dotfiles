return {
	...
	{
		dir = "/home/hq1/workspaces/shirotelin-remix",
		name = "shirotelin-remix",
		config = function()
			require("shirotelin-remix").setup({
				overrides = {
					Comment = { fg = "#005F00", italic = true },
				},
			})
			vim.o.background = "light"
			vim.cmd("colorscheme shirotelin-remix")
		end,
	},
	-- {
